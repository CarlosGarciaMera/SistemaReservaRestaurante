...
public class DaoListaNegraMysql implements DaoListaNegra {
    ...
    public boolean isVetado(Long id) {
        ...
        DtoListaNegra vetado = this.customNamedParameterJdbcTemplate.getNamedParameterJdbcTemplate().
                queryForObject(sqlFindById, parameterSource, new MapeoListaNegra());
        return vetado != null;
    }
}
